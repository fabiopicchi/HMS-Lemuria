package UI 
{
	...
	{
		private static const hammerImage : Image = Image.createRect (70, 79, 0xffff00, 0.5);
		private static const shieldImage : Image = Image.createRect (70, 79, 0xff00ff, 0.5);
		private static const hookShotImage : Image = Image.createRect (70, 79, 0x00ffff, 0.5);
		...
		{
			addGraphic(Image.createRect (539, 135, 0x000000, 0.5));
			addGraphic(textBox);
